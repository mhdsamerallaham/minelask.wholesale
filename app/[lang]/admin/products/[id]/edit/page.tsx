...
export default function EditProductPage({ params }: { params: Promise<{ lang: string, id: string }> }) {
    ...
    useEffect(() => {
        async function fetchData() {
            ...
            setVariantFiles(new Array(productVariants.length).fill(null));
            setMainImagePreview(product.primary_image_url || null);
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-12 pb-20">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-4xl font-bold font-heading text-slate-900 leading-tight">Edit Product</h1>
                    <p className="text-slate-500 font-medium">Update details for {form.name_en}</p>
                </div>
            </div>
